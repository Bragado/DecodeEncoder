...
public final class C {
  ...
  /**
   * Content types for {@link com.example.decoderencoder.library.audio.AudioAttributes}. One of {@link
  ...
  /**
   * Flags for {@link com.example.decoderencoder.library.audio.AudioAttributes}. Possible flag value is
  ...
  /**
   * Usage types for {@link com.example.decoderencoder.library.audio.AudioAttributes}. One of {@link
   ...
   * com.example.decoderencoder.library.audio.AudioAttributes} instance that will configure the
