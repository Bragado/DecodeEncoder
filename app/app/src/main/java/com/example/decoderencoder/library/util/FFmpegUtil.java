...
public class FFmpegUtil {
  ...
  /*  public static String[] AVCodecID = new String[] {         // only for reference, this does not have to be in memory
        ...
        "AV_CODEC_ID_MPEG2TS",          // FAKE codec to indicate a raw MPEG-2 TS stream (only used by lib"avformat)",
        "AV_CODEC_ID_MPEG4SYSTEMS",     // FAKE codec to indicate a MPEG-4 Systems stream (only used by lib"avformat)",
