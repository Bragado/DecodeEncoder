...
public final class MimeTypes {
  ...
  String getVideoMediaMimeType(@Nullable String codecs) {
    if (codecs == null) {
      return null;
    }
   ...
   */
  public static @Nullable
  String getAudioMediaMimeType(@Nullable String codecs) {
    if (codecs == null) {
      return null;
    }
    String[] codecList = Util.splitCodecs(codecs);
   ...
   */
  public static @Nullable
  String getMediaMimeType(@Nullable String codec) {
    if (codec == null) {
      return null;
    }
  ...
  String getTopLevelType(@Nullable String mimeType) {
    if (mimeType == null) {
      return null;
    }
  ...
  private static @Nullable
  String getCustomMimeTypeForCodec(String codec) {
    int customMimeTypeCount = customMimeTypes.size();
    for (int i = 0; i < customMimeTypeCount; i++) {
