...
public class RecorderClass {
    ...
    RecorderClass(Context mContext, UserSelectedParams userSelectedParams) {
        this.mContext = mContext;
        this.HdmiViewType = HdmiDisplayType.TEXTUREVIEW;
        this.DesireState.HdmiVideo = true;
        this.DesireState.HdmiAudio = true;

        DesireState.HdmiVideoRecording = true;
        DesireState.HdmiRecordToDeviceAllowed = true;

        DesireState.HdmiVideoStream = true;
        DesireState.UDP_Target_IP = userSelectedParams.output_address;
        DesireState.UDP_Target_Port = userSelectedParams.output_port;

        DesireState.VideoBitrate = userSelectedParams.video_bitrate;
        DesireState.Fps = userSelectedParams.frame_rate;

        DesireState.Width = userSelectedParams.width;
        DesireState.Height = userSelectedParams.height;

        DesireState.AudioSamples = 48000; // kHz
        init();
    }
    ...
    private android.view.TextureView TextureView = null;
    private android.view.SurfaceView SurfaceView = null;
    ...
    private class FloatingWindowTextureListener implements android.view.TextureView.SurfaceTextureListener {
        @Override
