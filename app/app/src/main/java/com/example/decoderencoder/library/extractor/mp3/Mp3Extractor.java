...
import com.example.decoderencoder.library.extractor.Id3Peeker;
...
import com.example.decoderencoder.library.metadata.id3.Id3Decoder;
import com.example.decoderencoder.library.metadata.id3.Id3Decoder.FramePredicate;
import com.example.decoderencoder.library.metadata.id3.MlltFrame;
...
public final class Mp3Extractor implements Extractor {
  ...
  public void init(ExtractorOutput output) {
    ...
    trackOutput = extractorOutput.track(null, 0, C.TRACK_TYPE_AUDIO);
