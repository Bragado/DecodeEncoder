 ...
 */
package com.example.decoderencoder.metadata.emsg;
...
import com.example.decoderencoder.library.metadata.emsg.EventMessageDecoder;
...
public final class EventMessageDecoderTest {
  ...
  public void testDecodeEventMessage() {
    ...
    //assertThat(eventMessage.durationMs).isEqualTo(3000);    // FIXME
