 ...
 */
package com.example.decoderencoder.extractor.mkv;

import com.example.decoderencoder.library.extractor.ExtractorInput;
import com.example.decoderencoder.library.extractor.mkv.VarintReader;
import com.example.decoderencoder.library.testutil.FakeExtractorInput;
import com.example.decoderencoder.library.testutil.FakeExtractorInput.SimulatedIOException;
...
import static com.example.decoderencoder.library.util.C.RESULT_END_OF_INPUT;
import static com.example.decoderencoder.library.util.C.RESULT_MAX_LENGTH_EXCEEDED;
