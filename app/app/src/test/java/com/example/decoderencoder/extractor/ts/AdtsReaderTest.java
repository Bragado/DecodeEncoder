...
import com.example.decoderencoder.library.extractor.ts.AdtsReader;
...
public class AdtsReaderTest {
  ...
  public void setUp() throws Exception {
    ...
    adtsOutput = fakeExtractorOutput.track(this , 0, C.TRACK_TYPE_AUDIO);
    id3Output = fakeExtractorOutput.track(this , 1, C.TRACK_TYPE_METADATA);
